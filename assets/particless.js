...
/* function initializeParticles() {
  ...
  var eduSection = document.querySelector(".edu");
  ...
  if (theme === 'dark') {
      ...
      // Initialize dark theme particles
      newDiv.className = "particlesss-js";
      newDiv.id = "particlesss-js";
      eduSection.appendChild(newDiv);
  } else {
      if (document.querySelector('#particlesss-js')) {
          document.querySelector('#particlesss-js').remove();
      }
      // Initialize light theme particles
      newDiv.className = "particles-container";
      newDiv.id = "particles-container";
      eduSection.appendChild(newDiv);
...
particlesJS("particlesss-js", {
  "particles": {
    "number": {
      "value": 100, // Reduced the number of particles to 100
      "density": {
        "enable": true,
  ...
  "retina_detect": true,
  "fps_limit": 30 // Set FPS limit to 30
});
